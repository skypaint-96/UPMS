...
/// <summary>
/// Thin DI wrapper for <see cref="TicketDataService"/> — preserved for backward compatibility
/// with components that inject <see cref="TicketDataServiceInstance"/> directly.
/// New code should inject <see cref="TicketDataService"/> directly.
/// </summary>
public class TicketDataServiceInstance
{
    ...
    public Task AddTicketsToSnapshotAsync(
        Guid snapshotId,
    ...
    public Task RecordFieldChangeAsync(
        string companyName,
        string ticketKey,
        string fieldName,
        string? fieldValue,
    ...
    public Task<IEnumerable<FieldChange>> GetTicketFieldHistoryAsync(
        string companyName,
        string ticketKey,
        string fieldName)
